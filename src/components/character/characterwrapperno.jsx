...
const CharacterWrapperNo = (props) => {
  const imgUrl = usePresignedImgQuery(
    "images/Characters/" + props.guid + ".jpg",
    props.path === "UnApproved" ||
      props.path === "CharacterSheets" ||
      props.character === undefined ||
      props.character === null ||
      props.character.img1 === undefined
      ? null
      : props.character.img1,
  );
  const imgUrl2 = usePresignedImgQuery(
    "images/Characters/" + props.guid + "_2.jpg",
    props.path === "UnApproved" ||
      props.path === "CharacterSheets" ||
      props.character === undefined ||
      props.character === null ||
      props.character.img2 === undefined
      ? null
      : props.character.img2,
  );
  ...
  if (imgUrl.error !== null && imgUrl2.error !== null)
    return (
      <div>
        Error! - Character Wrapper
        {props}
      </div>
    );
