...
export default function DeleteSanityDialog(props) {


const sanityResults = useGetData(props.sanityMutation, '/api/v1/'+ props.path + props.guid);
...
return (
    <>
    {
    ( sanityResults.data.characterLists !== undefined && sanityResults.data.characterLists.approvedCharacterSheets.length) > 0  || 
    ( sanityResults.data.characterLists !== undefined && sanityResults.data.characterLists.unapprovedCharacterSheets.length > 0)  ||
    ( sanityResults.data.itemLists !== undefined && sanityResults.data.itemLists.approvedItems.length > 0 ) ||
    ( sanityResults.data.itemLists !== undefined && sanityResults.data.itemLists.unapprovedItems.length > 0 ) || 
    ( sanityResults.data.seriesList !== undefined && sanityResults.data.seriesList.series.length > 0 )?
    <>
    <Dialog
  ...
  : <div></div>
   ...
   {sanityResults.data.characterLists !== undefined && sanityResults.data.characterLists.unapprovedCharacterSheets.length > 0
    ...
    DeleteSanityDialog.propTypes = {
      ...
      sanityMutation: PropTypes.string, 
