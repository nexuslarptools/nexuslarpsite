...
const ItemAttributeSearchField = (props) => {
    ...
    const formData = [];
        for (const key of Object.keys(formJSON)) {
          for (const subkey of Object.keys(formJSON[key].Values)) {
            ...
            if(jsonItem.inDropDown && ( props.type === '' || jsonItem.Types.includes('All') ||
                jsonItem.Types.includes(props.type) )) {
...
export default ItemAttributeSearchField;

ItemAttributeSearchField.propTypes = {
